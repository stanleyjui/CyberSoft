...
{
    /// <summary>
    /// 產生台電(一般電)扣帳回應檔,並將入帳交易先寫至TX_WAREHOUSE,待下一營業日入帳
    /// </summary>
    public class PBBELO001
    {
        ...
        public string RUN()
        {
            ...
            try
            {
                ...
                switch (PUBLIC_LIST_RC)
                {
                    ...
                    case "F0023": //無需處理資料
                        logger.strJobQueue = "今日無台電(一般電)回應檔需產生;今日需送回應檔時間為大於 " + PREV_PROCESS_DTE + "且小於等於" + TODAY_PROCESS_DTE;
                        logger.writeSysout(Cybersoft.Coca.Log.LevelEnum.Debug);
                        return "B0000";
                ...
                for (i = 0; i < PUBLIC_LIST.resultTable.Rows.Count; i++)
                {
                    ...
                    switch (strTag)
                    {
                        case "1":  //檔頭資料       
                            ...
                            TX_WAREHOUSE.strWhereMNT_USER = "PBBELO001";
                        ...
                        case "2":  //明細資料
                            ...
                            if (PAY_RESULT == "S000")
                            {
                                ...
                                if (TX_AMT > 0)
                                {
                                    ...
                                    TX_WAREHOUSE_T.resultTable.Rows[x]["MNT_USER"] = "PBBELO001";
                                }
                                #endregion
                                ...
                                PUBLIC_HIST.strMNT_USER = "PBBELO001";
                        ...
                        case "3": //檔尾資料
                            ...
                            #region 組檔尾
                            TEMP_SUCCESS_AMT = Convert.ToInt64(ELECT_SUCCESS_AMT * 100).ToString().PadLeft(16, '0');
                            TEMP_FAIL_AMT = Convert.ToInt64(ELECT_FAIL_AMT * 100).ToString().PadLeft(16, '0');
        ...
        void writeReport()
        {
            ...
            //產出報表
            CMCRPT001.Output(REPORT_TABLE, alSumData, alMegData, "PBRELO001(台電扣繳成功失敗報表_一般電)", "PBRELO001", "Sheet1", "Sheet1", TODAY_PROCESS_DTE, true);
        }
        #endregion
