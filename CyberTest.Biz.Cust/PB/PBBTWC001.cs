...
namespace Cybersoft.Biz.Cust
{
    ...
    public class PBBTWC001
    {
        ...
        //省水約定檔欄位
        String[] TWWATER_CHGOUT = null;
        String REC_TYPE = "2";
        String CHANGE_TYPE = "0";
        String CHANGE_DTE = "";
        String SEND_UNIT = "009     ";
        String RECV_UNIT = "CB      ";
        ...
        public string RUN()
        {
            ...
            try
            {
                ...
                //寫出檔案路徑
                FILE_PATH = CMCURL.getPATH("TWWATER_CHGOUT");

                if (FILE_PATH == "")
                {
                    logger.strJobQueue = "路徑取得錯誤!!! TWWATER_CHGOUT路徑為 " + FILE_PATH;
                ...
                else
                {
                    ...
                    logger.strJobQueue = " TWWATER_CHGOUT路徑為 " + FILE_PATH;
                    logger.writeSysout(Cybersoft.Coca.Log.LevelEnum.Debug);
                }
                #endregion

                #region 擷取今日需送約定檔之省水資料
                PUBLIC_APPLY.init();
                PUBLIC_APPLY.strWherePAY_TYPE = "0003";
                ...
                switch (PUBLIC_APPLY_RC)
                {
                    case "S0000": //查詢成功
                        ...
                        TWWATER_CHGOUT = new string[PUBLIC_APPLY_Query_Count];
                        break;

                    case "F0023": //無需處理資料
                        logger.strJobQueue = "今日無省水約定檔需產生;";
                        logger.writeSysout(Cybersoft.Coca.Log.LevelEnum.Debug);
                        break;
                ...
                for (i = 0; i < PUBLIC_APPLY.resultTable.Rows.Count; i++)
                {
                    ...
                    //組明細
                    TWWATER_CHGOUT[i] = REC_TYPE + SEND_UNIT + RECV_UNIT + PAY_ACCT_NBR + PAY_NBR.PadRight(11, ' ') +
                                        CHANGE_DTE + CHANGE_TYPE + new string(' ', 71);
                    //將變數值還原
                    CHANGE_TYPE = "0";
                    ...
                    //PUBLIC_APPLY.strMNT_USER = "PBBTWC001";
                ...
                #region 產生約定檔 陣列 --> 116Z_yyyymmdd_2200_001
                ...
                using (StreamWriter srOutFile = new StreamWriter(fsOutFile, BIG5))
                {
                    ...
                    {
                        srOutFile.Write(TWWATER_CHGOUT[k]);
                        srOutFile.Write("\r\n");
                        srOutFile.Flush();
        ...
        void writeDisplay()
        {
            ...
            //省水約定檔筆數(含頭尾)
            logger.strTBL_NAME = "TWWATER_CHGOUT";
